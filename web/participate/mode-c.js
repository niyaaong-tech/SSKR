  ...
  function render(root, context) {
    ...
    root.innerHTML = `
      <div class="completion-shell">
        ...
        <p>${waiting ? "참가 가능 인원이 확보되면 등록된 연락처로 안내해 드립니다." : "결제와 참가 등록이 모두 완료되었습니다. 이제 SSKR 매니저에서 이번 랠리를 준비할 수 있습니다."}</p>
        ...
        <div class="completion-actions"><a class="transaction-primary" href="/app">SSKR 매니저로 이동 <span aria-hidden="true">→</span></a><button class="transaction-secondary" id="completion-detail-toggle" type="button" aria-expanded="false" aria-controls="completion-detail">참가 신청 정보 확인</button></div>
