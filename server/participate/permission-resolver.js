...
function resolvePermissions({ event, participation, payment, surface }) {
  ...
  return {
    ...
    canEditBikeInfo: surface.mode === "MODE_B" || active,
    canStartCheckout: surface.mode === "MODE_B" && surface.step === APPLICATION_STEP.STEP_3 && surface.primaryAction?.code === "PREPARE_CHECKOUT" && surface.primaryAction?.enabled === true,
